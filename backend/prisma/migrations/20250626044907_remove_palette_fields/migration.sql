/*
  ...
  - You are about to drop the column `palette` on the `images` table. All the data in the column will be lost.
  - You are about to drop the column `paletteConfidence` on the `images` table. All the data in the column will be lost.
  - You are about to drop the column `paletteStatus` on the `images` table. All the data in the column will be lost.
